...
- Add 3 students
- Display All (option 3)
- Search for one student (option 2)
- Sort by Name (option 4a)
- Display Forward (option 8)
- Display Backward (option 9)
- Delete a student (option 5)
- Undo the delete (option 6)
- Redo the delete (option 7)
...
javac Student.java Project03_StudentADT.java
java Project03_StudentADT

javac Student.java Node.java Project11_SinglyLinkedList.java
java Project11_SinglyLinkedList

javac Student.java Node.java Project12_LinkedListOperations.java
java Project12_LinkedListOperations

javac Student.java DoublyNode.java Project13_DoublyLinkedList.java
java Project13_DoublyLinkedList
